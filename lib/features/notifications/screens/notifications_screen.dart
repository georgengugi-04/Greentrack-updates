            ...
            TextButton(
              onPressed: () => setState(() {
                _notifications = _notifications.map((n) =>
                  AppNotification(
                    id: n.id, title: n.title, body: n.body, emoji: n.emoji,
                    scheduledAt: n.scheduledAt, isRead: true,
                    cropId: n.cropId, type: n.type,
                  )).toList();
              }),
              ...
              return Padding(
                ...
                child: Slidable(
                  endActionPane: ActionPane(
                    ...
                    children: [
                      SlidableAction(
                        onPressed: (_) => setState(() => _notifications.removeAt(i)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(notification.body, style: AppTextStyles.body(11, color: AppColors.slateMid)),
                const SizedBox(height: 6),
